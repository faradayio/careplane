...
vows.describe('KayakFlight').addBatch({
  '.parse': {
    ...
    'parses airline, origin, destination, and aircraft': function(flights) {
      assert.match(flights[0].airline, /Continental/);
