...
var Careplane = require('./careplane'),
    HipmunkTrip = require('./drivers/hipmunk/hipmunk-trip'),
    KayakTrip = require('./drivers/kayak/kayak-trip'),
    KayakUKTrip = require('./drivers/kayak-uk/kayak-uk-trip'),
    OrbitzTrip = require('./drivers/orbitz/orbitz-trip');

var AirTrafficControllerEvents = require('./air-traffic-controller-events');

var AirTrafficController = function($) { this.$ = $; };
...
AirTrafficController.prototype.discoveredTripElements = function() {
  return this.$(this.trips).map(function(i, trip) {
...
AirTrafficController.prototype.createTrip = function(tripElement) {
  ...
  var trip = new this.tripClass(id, this.$, tripElement);
...
AirTrafficController.prototype.url = function() {
  return Careplane.url();
};
