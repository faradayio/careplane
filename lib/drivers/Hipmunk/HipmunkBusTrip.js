...
var BusTrip = require('../../BusTrip');

var HipmunkBusTrip = function(extension, origin, destination, duration) {
...
HipmunkBusTrip.parse = function(extension, leg) {
  ...
  return new HipmunkBusTrip(extension, origin, destination, duration);
};
